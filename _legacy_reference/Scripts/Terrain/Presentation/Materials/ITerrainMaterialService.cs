namespace ProjectTwo.Terrain.Presentation.Materials
{
    ...
    /// <summary>
    /// Contract responsible for creating, configuring, caching, and updating terrain and water materials.
    /// </summary>
    public interface ITerrainMaterialService : IDisposable
    {
        ...
        Material GetOrCreateTerrainMaterial(TerrainVisualProfileSO profile = null);
        ...
        Material GetOrCreateWaterMaterial(WaterVisualProfileSO waterProfile = null);

        /// <summary>
        /// Updates shader properties on active cached materials in response to live profile modifications.
        /// </summary>
